...
const DormDetail = () => {
  ...
  const fetchRoomDetails = async (roomId) => {
    ...
    try {
      const response = await axios.get(`https:/on-render-server-name/rooms/get_room_by_id/${roomId}`);
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const userResponse = await axios.get(`https:/on-render-server-name/users/get_user/${storedUserId}`);
        ...
        if (userData.group_id) {
          const roommatesResponse = await axios.get(`https:/on-render-server-name/users/roommates/${storedUserId}`);
        ...
        // Fetch all rooms
        const roomsResponse = await axios.get("https:/on-render-server-name/rooms");
        ...
        try {
          const filteredRoomsResponse = await axios.get(`https:/on-render-server-name/rooms/filtered/${storedUserId}`);
  ...
  const handleRoomSelect = async (roomId) => {
    try {
      ...
      const userResponse = await axios.get(`https:/on-render-server-name/users/get_user/${userId}`);
      const userData = userResponse.data;
      ...
      if (userData.room_id) {
        ...
        const unselectResponse = await axios.post("https:/on-render-server-name/rooms/unselectRoom", {
      ...
      const selectResponse = await axios.post("https:/on-render-server-name/rooms/selectRoom", {
        room_id: roomId,
        user_id: userId
      });
