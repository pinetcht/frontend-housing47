    ...
    const fetchUserData = async () => {
      try {
        ...
        if (response.data.room_id) {
          try {
            const roomResponse = await axios.get(`https:/on-render-server-name/rooms/get_room_by_id/${response.data.room_id}`);
        ...
        if (response.data.group_id) {
          try {
            const roommatesResponse = await axios.get(`https:/on-render-server-name/users/roommates/${userId}`);
